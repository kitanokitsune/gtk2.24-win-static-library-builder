...
cairo: ./mk/cairo.makefile
	tar xf pkg/cairo-1.17.4.tar.xz
	patch -p1 -d cairo-1.17.4 < src/cairo-1-fixes.patch
	sed -i 's,libpng12,libpng,g' cairo-1.17.4/configure
	sed -i 's,^\(Libs:.*\),\1 @CAIRO_NONPKGCONFIG_LIBS@,' cairo-1.17.4/src/cairo.pc.in
	cd cairo-1.17.4 && \
