...
glib: ./mk/glib.makefile
	tar xf pkg/glib-2.70.2.tar.xz
	patch -p1 -d glib-2.70.2 < src/glib-1-fixes.patch
	patch -p1 -d glib-2.70.2 < src/glib-2-link-with-libuuid.patch
	patch -p1 -d glib-2.70.2 < src/glib-3-static-link.patch
	cd glib-2.70.2 && \
