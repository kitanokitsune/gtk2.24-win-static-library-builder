...
if(NOT ${CMAKE_COMMAND} STREQUAL /mingw32/bin/cmake AND NOT DEFINED ENV{_MXE_CMAKE_TOOLCHAIN_INCLUDED})
    message(WARNING "
** Warning: direct use of toolchain file is deprecated
** Please use prefixed wrapper script instead:
     i686-w64-mingw32-cmake [options] <path-to-source>
       - uses mxe supplied cmake version 3.19.3
       - loads toolchain
...
set(CMAKE_FIND_ROOT_PATH /opt/i686-w64-mingw32 CACHE PATH "List of root paths to search on the filesystem")
set(CMAKE_PREFIX_PATH /mingw32 CACHE PATH "List of directories specifying installation prefixes to be searched")
set(CMAKE_INSTALL_PREFIX /gtk2-dev CACHE PATH "Installation Prefix")
# For custom mxe FindPackage scripts
set(CMAKE_MODULE_PATH "/gtk2-dev/share/cmake/modules" ${CMAKE_MODULE_PATH})
...
set(CMAKE_C_IMPLICIT_INCLUDE_DIRECTORIES /opt/i686-w64-mingw32/include)
set(CMAKE_CXX_IMPLICIT_INCLUDE_DIRECTORIES /opt/i686-w64-mingw32/include)


## Programs
set(CMAKE_C_COMPILER /opt/bin/i686-w64-mingw32-gcc)
set(CMAKE_CXX_COMPILER /opt/bin/i686-w64-mingw32-g++)
set(CMAKE_Fortran_COMPILER /opt/bin/i686-w64-mingw32-gfortran)
set(CMAKE_RC_COMPILER /opt/bin/windres)
# CMAKE_RC_COMPILE_OBJECT is defined in:
#     <cmake root>/share/cmake-X.Y/Modules/Platform/Windows-windres.cmake
set(CPACK_NSIS_EXECUTABLE i686-w64-mingw32-makensis)

## Individual package configuration
file(GLOB mxe_cmake_files
    "/gtk2-dev/share/cmake/mxe-conf.d/*.cmake"
)
